...
return {
  {
    ...
    keys = {
      { mode = { "n" }, "<Leader>tp", "<Cmd>Telekasten panel<CR>", desc = "Telekasten Panel" },
      { mode = { "n" }, "<Leader>tf", "<Cmd>Telekasten find_notes<CR>" },
      { mode = { "n" }, "<Leader>tg", "<Cmd>Telekasten search_notes<CR>" },
      { mode = { "n" }, "<Leader>td", "<Cmd>Telekasten goto_today<CR>" },
      { mode = { "n" }, "<Leader>tw", "<Cmd>Telekasten goto_thisweek<CR>" },
      { mode = { "n" }, "<Leader>tz", "<Cmd>Telekasten follow_link<CR>" },
      { mode = { "n" }, "<Leader>tn", "<Cmd>Telekasten new_note<CR>" },
      { mode = { "n" }, "<Leader>tc", "<Cmd>Telekasten show_calendar<CR>" },
      { mode = { "n" }, "<Leader>tb", "<Cmd>Telekasten show_backlinks<CR>" },
      { mode = { "n" }, "<Leader>tI", "<Cmd>Telekasten insert_img_link<CR>" },
